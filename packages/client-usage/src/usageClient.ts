...
export function createUsageClient({
  ...
  return {
     ...
     * @param getIndexUsage.startDate - Start date in ISO 8601 format of the time period to analyze.
     * @param getIndexUsage.endDate - End date in ISO 8601 format of the time period to analyze.
     ...
     * @param getUsage.startDate - Start date in ISO 8601 format of the time period to analyze.
     * @param getUsage.endDate - End date in ISO 8601 format of the time period to analyze.
