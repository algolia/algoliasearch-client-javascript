...
```bash
yarn add algoliasearch@5.9.1
# or
npm install algoliasearch@5.9.1
# or
pnpm add algoliasearch@5.9.1
```
...
```html
// for the full client
<script src="https://cdn.jsdelivr.net/npm/algoliasearch@5.9.1/dist/algoliasearch.umd.js"></script>

// for the lite client
<script src="https://cdn.jsdelivr.net/npm/algoliasearch@5.9.1/dist/lite/builds/browser.umd.js"></script>
```
