...
```bash
yarn add @algolia/client-abtesting@5.48.2
# or
npm install @algolia/client-abtesting@5.48.2
# or
pnpm add @algolia/client-abtesting@5.48.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-abtesting@5.48.2/dist/builds/browser.umd.js"></script>
```
