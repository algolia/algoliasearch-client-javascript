...
```bash
yarn add @algolia/client-abtesting@5.29.0
# or
npm install @algolia/client-abtesting@5.29.0
# or
pnpm add @algolia/client-abtesting@5.29.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-abtesting@5.29.0/dist/builds/browser.umd.js"></script>
```
