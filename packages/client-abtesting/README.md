...
```bash
yarn add @algolia/client-abtesting@5.46.4
# or
npm install @algolia/client-abtesting@5.46.4
# or
pnpm add @algolia/client-abtesting@5.46.4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-abtesting@5.46.4/dist/builds/browser.umd.js"></script>
```
