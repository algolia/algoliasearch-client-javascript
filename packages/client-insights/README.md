...
```bash
yarn add @algolia/client-insights@5.20.1
# or
npm install @algolia/client-insights@5.20.1
# or
pnpm add @algolia/client-insights@5.20.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-insights@5.20.1/dist/builds/browser.umd.js"></script>
```
