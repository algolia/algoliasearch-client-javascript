...
```bash
yarn add @algolia/client-insights@5.26.0
# or
npm install @algolia/client-insights@5.26.0
# or
pnpm add @algolia/client-insights@5.26.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-insights@5.26.0/dist/builds/browser.umd.js"></script>
```
