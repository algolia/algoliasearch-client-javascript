...
```bash
yarn add @algolia/client-search@5.20.3
# or
npm install @algolia/client-search@5.20.3
# or
pnpm add @algolia/client-search@5.20.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-search@5.20.3/dist/builds/browser.umd.js"></script>
```
