...
```bash
yarn add @algolia/client-search@5.10.2
# or
npm install @algolia/client-search@5.10.2
# or
pnpm add @algolia/client-search@5.10.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-search@5.10.2/dist/builds/browser.umd.js"></script>
```
