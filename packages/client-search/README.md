...
```bash
yarn add @algolia/client-search@5.27.0
# or
npm install @algolia/client-search@5.27.0
# or
pnpm add @algolia/client-search@5.27.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-search@5.27.0/dist/builds/browser.umd.js"></script>
```
