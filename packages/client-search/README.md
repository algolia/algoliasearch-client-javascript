...
```bash
yarn add @algolia/client-search@5.20.1
# or
npm install @algolia/client-search@5.20.1
# or
pnpm add @algolia/client-search@5.20.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-search@5.20.1/dist/builds/browser.umd.js"></script>
```
