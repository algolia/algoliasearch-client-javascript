...
```bash
yarn add @algolia/advanced-personalization@0.0.1-alpha.27
# or
npm install @algolia/advanced-personalization@0.0.1-alpha.27
# or
pnpm add @algolia/advanced-personalization@0.0.1-alpha.27
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/advanced-personalization@0.0.1-alpha.27/dist/builds/browser.umd.js"></script>
```
