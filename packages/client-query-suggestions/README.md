...
```bash
yarn add @algolia/client-query-suggestions@5.30.0
# or
npm install @algolia/client-query-suggestions@5.30.0
# or
pnpm add @algolia/client-query-suggestions@5.30.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-query-suggestions@5.30.0/dist/builds/browser.umd.js"></script>
```
