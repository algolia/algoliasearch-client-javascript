...
```bash
yarn add @algolia/client-query-suggestions@5.20.4
# or
npm install @algolia/client-query-suggestions@5.20.4
# or
pnpm add @algolia/client-query-suggestions@5.20.4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-query-suggestions@5.20.4/dist/builds/browser.umd.js"></script>
```
