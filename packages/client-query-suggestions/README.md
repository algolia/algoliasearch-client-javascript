...
```bash
yarn add @algolia/client-query-suggestions@5.23.3
# or
npm install @algolia/client-query-suggestions@5.23.3
# or
pnpm add @algolia/client-query-suggestions@5.23.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-query-suggestions@5.23.3/dist/builds/browser.umd.js"></script>
```
