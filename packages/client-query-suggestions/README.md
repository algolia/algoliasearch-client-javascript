...
```bash
yarn add @algolia/client-query-suggestions@5.49.2
# or
npm install @algolia/client-query-suggestions@5.49.2
# or
pnpm add @algolia/client-query-suggestions@5.49.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-query-suggestions@5.49.2/dist/builds/browser.umd.js"></script>
```
