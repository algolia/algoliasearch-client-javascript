...
```bash
yarn add @algolia/client-analytics@5.48.2
# or
npm install @algolia/client-analytics@5.48.2
# or
pnpm add @algolia/client-analytics@5.48.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-analytics@5.48.2/dist/builds/browser.umd.js"></script>
```
