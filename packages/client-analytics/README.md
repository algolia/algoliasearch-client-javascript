...
```bash
yarn add @algolia/client-analytics@5.46.3
# or
npm install @algolia/client-analytics@5.46.3
# or
pnpm add @algolia/client-analytics@5.46.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-analytics@5.46.3/dist/builds/browser.umd.js"></script>
```
