...
```bash
yarn add @algolia/client-analytics@5.11.0
# or
npm install @algolia/client-analytics@5.11.0
# or
pnpm add @algolia/client-analytics@5.11.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-analytics@5.11.0/dist/builds/browser.umd.js"></script>
```
