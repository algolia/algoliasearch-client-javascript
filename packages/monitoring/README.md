...
```bash
yarn add @algolia/monitoring@1.7.0
# or
npm install @algolia/monitoring@1.7.0
# or
pnpm add @algolia/monitoring@1.7.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/monitoring@1.7.0/dist/builds/browser.umd.js"></script>
```
