...
```bash
yarn add @algolia/monitoring@1.23.2
# or
npm install @algolia/monitoring@1.23.2
# or
pnpm add @algolia/monitoring@1.23.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/monitoring@1.23.2/dist/builds/browser.umd.js"></script>
```
