...
```bash
yarn add @algolia/client-composition@0.0.1-alpha.10
# or
npm install @algolia/client-composition@0.0.1-alpha.10
# or
pnpm add @algolia/client-composition@0.0.1-alpha.10
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-composition@0.0.1-alpha.10/dist/builds/browser.umd.js"></script>
```
