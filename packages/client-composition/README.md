...
```bash
yarn add @algolia/client-composition@1.9.0
# or
npm install @algolia/client-composition@1.9.0
# or
pnpm add @algolia/client-composition@1.9.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-composition@1.9.0/dist/builds/browser.umd.js"></script>
```
