...
```bash
yarn add @algolia/client-composition@1.1.0
# or
npm install @algolia/client-composition@1.1.0
# or
pnpm add @algolia/client-composition@1.1.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-composition@1.1.0/dist/builds/browser.umd.js"></script>
```
