...
```bash
yarn add @algolia/client-composition@0.0.1-alpha.18
# or
npm install @algolia/client-composition@0.0.1-alpha.18
# or
pnpm add @algolia/client-composition@0.0.1-alpha.18
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-composition@0.0.1-alpha.18/dist/builds/browser.umd.js"></script>
```
