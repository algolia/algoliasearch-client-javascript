...
```bash
yarn add @algolia/client-composition@0.0.1-alpha.17
# or
npm install @algolia/client-composition@0.0.1-alpha.17
# or
pnpm add @algolia/client-composition@0.0.1-alpha.17
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/client-composition@0.0.1-alpha.17/dist/builds/browser.umd.js"></script>
```
