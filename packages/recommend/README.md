...
```bash
yarn add @algolia/recommend@5.27.0
# or
npm install @algolia/recommend@5.27.0
# or
pnpm add @algolia/recommend@5.27.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@5.27.0/dist/builds/browser.umd.js"></script>
```
