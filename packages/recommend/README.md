...
```bash
yarn add @algolia/recommend@5.20.3
# or
npm install @algolia/recommend@5.20.3
# or
pnpm add @algolia/recommend@5.20.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@5.20.3/dist/builds/browser.umd.js"></script>
```
