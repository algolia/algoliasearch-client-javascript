...
```bash
yarn add @algolia/recommend@5.48.2
# or
npm install @algolia/recommend@5.48.2
# or
pnpm add @algolia/recommend@5.48.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@5.48.2/dist/builds/browser.umd.js"></script>
```
