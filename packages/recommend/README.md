...
```bash
yarn add @algolia/recommend@5.46.4
# or
npm install @algolia/recommend@5.46.4
# or
pnpm add @algolia/recommend@5.46.4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/recommend@5.46.4/dist/builds/browser.umd.js"></script>
```
