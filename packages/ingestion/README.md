...
```bash
yarn add @algolia/ingestion@1.37.0
# or
npm install @algolia/ingestion@1.37.0
# or
pnpm add @algolia/ingestion@1.37.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/ingestion@1.37.0/dist/builds/browser.umd.js"></script>
```
