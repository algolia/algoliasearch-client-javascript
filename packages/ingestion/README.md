...
```bash
yarn add @algolia/ingestion@1.46.4
# or
npm install @algolia/ingestion@1.46.4
# or
pnpm add @algolia/ingestion@1.46.4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/ingestion@1.46.4/dist/builds/browser.umd.js"></script>
```
