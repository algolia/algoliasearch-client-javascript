...
```bash
yarn add @algolia/ingestion@1.46.3
# or
npm install @algolia/ingestion@1.46.3
# or
pnpm add @algolia/ingestion@1.46.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/ingestion@1.46.3/dist/builds/browser.umd.js"></script>
```
