...
```bash
yarn add @algolia/composition@1.22.4-beta.1
# or
npm install @algolia/composition@1.22.4-beta.1
# or
pnpm add @algolia/composition@1.22.4-beta.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/composition@1.22.4-beta.1/dist/builds/browser.umd.js"></script>
```
