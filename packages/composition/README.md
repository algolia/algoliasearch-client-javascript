...
```bash
yarn add @algolia/composition@1.30.2
# or
npm install @algolia/composition@1.30.2
# or
pnpm add @algolia/composition@1.30.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/composition@1.30.2/dist/builds/browser.umd.js"></script>
```
