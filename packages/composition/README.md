...
```bash
yarn add @algolia/composition@1.24.0
# or
npm install @algolia/composition@1.24.0
# or
pnpm add @algolia/composition@1.24.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/composition@1.24.0/dist/builds/browser.umd.js"></script>
```
