...
```bash
yarn add @algolia/abtesting@1.12.4
# or
npm install @algolia/abtesting@1.12.4
# or
pnpm add @algolia/abtesting@1.12.4
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@1.12.4/dist/builds/browser.umd.js"></script>
```
