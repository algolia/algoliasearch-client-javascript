...
```bash
yarn add @algolia/abtesting@0.0.1-alpha.1
# or
npm install @algolia/abtesting@0.0.1-alpha.1
# or
pnpm add @algolia/abtesting@0.0.1-alpha.1
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@0.0.1-alpha.1/dist/builds/browser.umd.js"></script>
```
