...
```bash
yarn add @algolia/abtesting@1.15.2
# or
npm install @algolia/abtesting@1.15.2
# or
pnpm add @algolia/abtesting@1.15.2
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@1.15.2/dist/builds/browser.umd.js"></script>
```
