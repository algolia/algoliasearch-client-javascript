...
```bash
yarn add @algolia/abtesting@0.0.1-alpha.3
# or
npm install @algolia/abtesting@0.0.1-alpha.3
# or
pnpm add @algolia/abtesting@0.0.1-alpha.3
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@0.0.1-alpha.3/dist/builds/browser.umd.js"></script>
```
