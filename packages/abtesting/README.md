...
```bash
yarn add @algolia/abtesting@1.16.0
# or
npm install @algolia/abtesting@1.16.0
# or
pnpm add @algolia/abtesting@1.16.0
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@algolia/abtesting@1.16.0/dist/builds/browser.umd.js"></script>
```
