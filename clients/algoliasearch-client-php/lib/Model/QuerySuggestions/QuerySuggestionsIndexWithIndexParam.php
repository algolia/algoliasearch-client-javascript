 ...
 */
class QuerySuggestionsIndexWithIndexParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QuerySuggestionsIndexWithIndexParam';
