 ...
 */
class GetNoResultsRateResponseDates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNoResultsRateResponse_dates';
