 ...
 */
class GetAverageClickPositionResponseDates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAverageClickPositionResponse_dates';
