 ...
 */
class GetTopFilterForAttributeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTopFilterForAttributeResponse';
