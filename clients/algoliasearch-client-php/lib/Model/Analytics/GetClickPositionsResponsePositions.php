 ...
 */
class GetClickPositionsResponsePositions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getClickPositionsResponse_positions';
