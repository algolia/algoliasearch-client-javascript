 ...
 */
class GetTopFiltersNoResultsValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTopFiltersNoResultsValues';
