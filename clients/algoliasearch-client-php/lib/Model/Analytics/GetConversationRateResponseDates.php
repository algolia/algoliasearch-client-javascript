 ...
 */
class GetConversationRateResponseDates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getConversationRateResponse_dates';
