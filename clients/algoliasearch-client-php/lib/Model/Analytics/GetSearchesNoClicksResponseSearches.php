 ...
 */
class GetSearchesNoClicksResponseSearches implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSearchesNoClicksResponse_searches';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['withFilterCount'] = $data['withFilterCount'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['withFilterCount'] === null) {
    ...
    {
        return $this->container['withFilterCount'];
    }
