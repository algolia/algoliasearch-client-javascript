 ...
 */
class GetNoClickRateResponseDates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getNoClickRateResponse_dates';
