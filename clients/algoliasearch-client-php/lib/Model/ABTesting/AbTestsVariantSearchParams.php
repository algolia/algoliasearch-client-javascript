 ...
 */
class AbTestsVariantSearchParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'abTestsVariantSearchParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['customSearchParameters'] = $data['customSearchParameters'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customSearchParameters'] === null) {
    ...
    {
        return $this->container['customSearchParameters'];
    }
