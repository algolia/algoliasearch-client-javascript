 ...
 */
class ListABTestsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listABTestsResponse';
    ...
    {
        $this->container['abtests'] = $data['abtests'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['abtests'] === null) {
