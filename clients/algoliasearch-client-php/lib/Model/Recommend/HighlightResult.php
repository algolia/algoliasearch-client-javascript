 ...
 */
class HighlightResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'highlightResult';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['matchLevel'] = $data['matchLevel'] ?? null;
        $this->container['matchedWords'] = $data['matchedWords'] ?? null;
        $this->container['fullyHighlighted'] = $data['fullyHighlighted'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['matchLevel']) && !in_array($this->container['matchLevel'], $allowedValues, true)) {
    ...
    {
        return $this->container['matchedWords'];
    }
    ...
    {
        return $this->container['fullyHighlighted'];
    }
