 ...
 */
class GetTopUserIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTopUserIdsResponse';
    ...
    {
        $this->container['topUsers'] = $data['topUsers'] ?? null;
    }
    ...
    {
        return $this->container['topUsers'];
    }
