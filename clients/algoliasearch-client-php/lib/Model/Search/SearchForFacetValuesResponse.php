 ...
 */
class SearchForFacetValuesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchForFacetValuesResponse';
    ...
    {
        $this->container['facetHits'] = $data['facetHits'] ?? null;
    }
    ...
    {
        return $this->container['facetHits'];
    }
