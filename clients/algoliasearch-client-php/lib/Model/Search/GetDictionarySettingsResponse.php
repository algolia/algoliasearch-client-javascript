 ...
 */
class GetDictionarySettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getDictionarySettingsResponse';
    ...
    {
        $this->container['disableStandardEntries'] = $data['disableStandardEntries'] ?? null;
    }
    ...
    {
        return $this->container['disableStandardEntries'];
    }
