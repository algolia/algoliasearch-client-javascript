 ...
 */
class ConsequenceParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'consequenceParams';
    ...
    public function setDistinct($distinct)
    {
        ...
        if (!is_null($distinct) && ($distinct < 0)) {
            throw new \InvalidArgumentException('invalid value for $distinct when calling ConsequenceParams., must be bigger than or equal to 0.');
        }
