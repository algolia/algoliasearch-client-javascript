 ...
 */
class SearchUserIdsResponseHighlightResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchUserIdsResponse__highlightResult';
