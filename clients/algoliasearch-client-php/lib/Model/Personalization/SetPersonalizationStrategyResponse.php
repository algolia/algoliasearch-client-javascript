 ...
 */
class SetPersonalizationStrategyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'setPersonalizationStrategyResponse';
