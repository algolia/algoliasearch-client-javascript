 ...
 */
class DeleteUserProfileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteUserProfileResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['deletedUntil'] = $data['deletedUntil'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deletedUntil'] === null) {
    ...
    {
        return $this->container['deletedUntil'];
    }
