 ...
 */
class GetUserTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getUserTokenResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lastEventAt'] = $data['lastEventAt'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lastEventAt'] === null) {
    ...
    {
        return $this->container['lastEventAt'];
    }
