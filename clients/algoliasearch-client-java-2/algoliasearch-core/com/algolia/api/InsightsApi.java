...
public class InsightsApi extends ApiClient {

  public InsightsApi(String appId, String apiKey) {
  ...
  public InsightsApi(String appId, String apiKey, Requester requester) {
