...
// Project: http://github.com/algolia/algoliasearch-client-js


/**
 * Describes the answer from algolia's api after a search operation
 */
...
interface IAlgoliaClient {
     ...
     */
    initIndex(name:string):IAlgoliaIndex;
    /**
     ...
     */
    search(queries:{ indexName:string, query:string, options:IAlgoliaQueryParameters }, cb:Function);
    /**
     * Query on multiple index
     * @param queries index name, query and query parameters
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#multiple-queries---multiplequeries
     */
    search(queries:{ indexName:string, query:string, options:IAlgoliaQueryParameters }) : Promise<IAlgoliaResponse>;
    /**
     * clear browser cache
     ...
     */
    deleteIndex(name:string, cb:Function);
    /**
     * Delete a specific index
     * @param name
     * return {Promise}
     ...
     */
    copyIndex(from:string, to:string, cb:Function);
    /**
     * Copy an  index from a specific index to a new one
     * @param from origin index
     * @param to destination index
     ...
     */
    moveIndex(from:string, to:string, cb:Function);
    /**
     * Move index to a new one (and will overwrite the original one)
     * @param from origin index
     * @param to destination index
     ...
     */
    generateSecuredApiKey(key:string, filters:IAlgoliaSecuredApiOptions);
    /**
     ...
     */
    batch(action:IAlgoliaAction, cb:Function);
    /**
     * Perform multiple operations with one API call to reduce latency
     * @param action
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#custom-batch---batch
     */
    batch(action:IAlgoliaAction) : Promise<any>;
    /**
     * Browse an index
     * @param query
     ...
     */
    browse(query:string, cb:Function);
    /**
     * Browse an index
     * @param query
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     */
    browse(query:string) : Promise<{cursor? : string, hits: any[], params: string, query: string, processingTimeMS: number}>;
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     */
    browseFrom(cursor:string, cb:Function);
    /**
     * Browse an index from a cursor
     * @param cursor
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     */
    browseFrom(cursor:string) : Promise<{cursor? : string, hits: any[], params: string, query: string, processingTimeMS: number}>;
    /**
     * Browse an entire index
     * return Promise
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     */
    browseAll():Promise<IAlgoliaResponse>;
    /**
     * Lists global API Keys
     * @param cb(err, res)
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     */
    listUserKeys(cb:Function);
    /**
     * Lists global API Keys
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
     ...
     */
    addUserKey(scopes:string[], cb:Function);
    /**
     * Add global API Keys
     * @param scopes
     * return {Promise}
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-user-key---adduserkey
     */
    addUserKey(scopes:string[], options:IAlgoliaUserKeyOptions, cb:Function);
    /**
     * Add global API Key
     * @param scopes
     * @param options
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-user-key---adduserkey
     */
    addUserKey(scopes:string[], options:IAlgoliaUserKeyOptions) : Promise<any>;
    /**
     ...
     */
    updateUserKey(key:string, scopes:string[], cb:Function);
    /**
     * Update global API key
     * @param key
     * @param scopes
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-user-key---updateuserkey
     */
    updateUserKey(key:string, scopes:string[], options:IAlgoliaUserKeyOptions, cb:Function);
    /**
     * Update global API key
     * @param key
     * @param scopes
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-user-key---updateuserkey
     */
    updateUserKey(key:string, scopes:string[], options:IAlgoliaUserKeyOptions) : Promise<any>;
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-user-key---updateuserkey
     */
    getUserKeyACL(key:string, cb:Function);
    /**
     * Gets the rights of a global key
     * @param key
     * return {Promise}
     ...
     */
    deleteUserKey(key:string, cb:Function);
    /**
     * Deletes a global key
     * @param key
     * return {Promise}
     ...
     */
    getLogs(options:ILogsOptions, cb:Function);
    /**
     * Get 1000 last events
     * @param options
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#get-logs---getlogs
     */
    getLogs(options:ILogsOptions) : Promise<any>;
}
/**
...
interface IAlgoliaIndex {
     ...
     */
    getObject(objectID:string, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#find-by-ids---getobjects
     */
    getObject(objectID:string, attributes: string[], cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#find-by-ids---getobjects
     */
    getObjects(objectIDs:string[], cb:Function);
    /**
     ...
     */
    addObject(object:Object, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
     */
    addObject(object:Object, objectID:string, cb:Function);
    /**
     * Add list of objects
     * @param objects
     * @param cb(err, res)
     * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
     */
    addObjects(objects:Object[], cb:Function);
    /**
     ...
     */
    saveObject(object:Object, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    saveObjects(objects:Object[], cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    partialUpdateObject(object:Object, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    partialUpdateObjects(objects:Object[], cb:Function);
    /**
     ...
     */
    deleteObject(objectID:string, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#delete-objects---deleteobjects
     */
    deleteObjects(objectIDs:string[], cb:Function);
    /**
     ...
     */
    deleteByQuery(query:string, cb:Function);
    /**
     * Delete objects that matches the query
     * @param query
     ...
     * https://github.com/algolia/algoliasearch-client-js#delete-by-query---deletebyquery
     */
    deleteByQuery(query:string, params:Object, cb:Function);
    /**
     ...
     */
    setSettings(settings:IAlgoliaIndexSettings, cb:Function);
    /**
     ...
     */
    saveSynonym(synonym:IAlgoliaSynonym, option:ISynonymOption, cb:Function);
    /**
     * Save a synonym object
     * @param synonyms
     * @param options
     * @param cb(err, res)
     */
    batchSynonyms(synonyms:IAlgoliaSynonym[], options:ISynonymOption, cb:Function);
    /**
     ...
     */
    deleteSynonym(identifier:string, options:ISynonymOption, cb:Function);
    /**
     ...
     */
    clearSynonyms(options:ISynonymOption, cb:Function);
    /**
     ...
     */
    getSynonym(identifier:string, cb:Function);
    /**
     * Search a synonyms
     * @param options
     * @param cb(err, res)
     ...
     */
    searchSynonyms(options:ISearchSynonymOptions, cb:Function);
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
     */
    addObject(object:Object) : Promise<any> ;
    /**
     * Add a list of objects
     * @param object with objectID
     * @param objectID
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
     */
    addObject(object:Object, objectID:string) : Promise<any> ;
    /**
     * Add list of objects
     * @param objects
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
     */
    addObjects(objects:Object[]) : Promise<any> ;
    /**
     * Add or replace a specific object
     * @param object
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    saveObject(object:Object) : Promise<any> ;
    /**
     * Add or replace several objects
     * @param objects
     * return {Promise}
     ...
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    partialUpdateObject(object:Object) : Promise<any> ;
    /**
     * Update parameters of a list of objects
     * @param objects
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
     */
    partialUpdateObjects(objects:Object[]) : Promise<any> ;
    /**
     * Delete a specific object
     * @param objectID
     * return {Promise}
     ...
     * https://github.com/algolia/algoliasearch-client-js#delete-by-query---deletebyquery
     */
    deleteByQuery(query:string, params:Object) : Promise<any> ;
    /**
     * Wait for an indexing task to be compete
     * @param taskID
     * return {Promise}
     ...
     * https://github.com/algolia/algoliasearch-client-js#set-settings---setsettings
     */
    setSettings(settings:IAlgoliaIndexSettings) : Promise<any> ;
    /**
     * Search in an index
     ...
     */
    search(params:IAlgoliaQueryParameters) : Promise<any> ;
    /**
     * Search in an index
     * @param params query parameter
     * @param cb(err, res)
     ...
     * https://github.com/algolia/algoliasearch-client-js#search-in-an-index---search
     */
    search(params:IAlgoliaQueryParameters, cb:Function);
    /**
     * Clear an index content
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#clear-index---clearindex
     ...
     * https://github.com/algolia/algoliasearch-client-js#save-synonym---savesynonym
     */
    saveSynonym(synonym:IAlgoliaSynonym, option:ISynonymOption) : Promise<any> ;
    /**
     * Save a synonym object
     * @param synonyms
     * @param options
     * return {Promise}
     */
    batchSynonyms(synonyms:IAlgoliaSynonym[], options:ISynonymOption) : Promise<any> ;
    /**
     * Delete a specific synonym
     * @param identifier
     * @param options
     ...
     * https://github.com/algolia/algoliasearch-client-js#batch-synonyms---batchsynonyms
     */
    deleteSynonym(identifier:string, options:ISynonymOption) : Promise<any> ;
    /**
     * Clear all synonyms of an index
     * @param options
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#clear-all-synonyms---clearsynonyms
     */
    clearSynonyms(options:ISynonymOption) : Promise<any> ;
    /**
     * Get a specific synonym
     * @param identifier
     * return {Promise}
     ...
     * https://github.com/algolia/algoliasearch-client-js#search-synonyms---searchsynonyms
     */
    searchSynonyms(options:ISearchSynonymOptions) : Promise<any> ;
    /**
     * List index user keys
     * return {Promise}
     * https://github.com/algolia/algoliasearch-client-js#list-api-keys---listapikeys
 ...
 */
interface IAlgoliaUserKeyOptions {
    /**
     ...
     * https://github.com/algolia/algoliasearch-client-js#add-user-key---adduserkey
     */
    queryParameters?:IAlgoliaQueryParameters;
    /**
 ...
 */
interface ISearchSynonymOptions {
    /**
 ...
 */
interface IAlgoliaSecuredApiOptions {
    /**
 ...
 */
interface IAlgoliaIndexSettings {
    /**
...
interface IAlgoliaQueryParameters {
    /**
...
declare module "algoliasearch" {
	var algoliasearch:(a:string, b:string, options? : IClientOptions) => IAlgoliaClient;
