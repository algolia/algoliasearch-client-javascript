...
```bash
yarn add algoliasearch@5.58.0
# or
npm install algoliasearch@5.58.0
# or
pnpm add algoliasearch@5.58.0
```
...
```html
// for the full client
<script src="https://cdn.jsdelivr.net/npm/algoliasearch@5.58.0/dist/algoliasearch.umd.js"></script>

// for the lite client
<script src="https://cdn.jsdelivr.net/npm/algoliasearch@5.58.0/dist/lite/builds/browser.umd.js"></script>
```
